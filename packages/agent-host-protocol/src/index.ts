...
export {
  ...
  TAILNET_PROBE_CHALLENGE_HANDOFF_PREFIX,
  TAILNET_PROBE_CHALLENGE_VERSION,
  TAILNET_PROBE_CLOCK_SKEW_MS,
  TAILNET_PROBE_DIGEST_ALGORITHM,
  TAILNET_PROBE_DIGEST_PREFIX,
  TAILNET_PROBE_MAX_TTL_MS,
  canonicalizeTailnetProbeChallenge,
