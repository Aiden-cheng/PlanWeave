...
export const enCatalog = {
  ...
  localServerDescription:
    "Host collaboration on this device. Enable the selected canvas to make it available to local members and agents.",
  ...
  localServerCurrentCanvasReady: "Current canvas is hosted",
  localServerOwnerPending:
    "Waiting to initialize an owner before current-canvas access can be registered.",
  localServerDefaultOwnerName: "Local owner",
  localServerTrustedScope: "Trusted canvas scopes",
  localServerRegisterCurrent: "Enable current canvas",
