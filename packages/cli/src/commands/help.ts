...
export const planweaveHelpTopics: HelpTopic[] = [
  ...
  },
  {
    ...
    notes: [
      "CLI and ACP are alternative transports: canonical agent names follow the configured transport, while explicit *-acp names select ACP; execution never falls back between them.",
