...
export function createTailscaleWebSocketProbe(
  requestHttps: typeof request = request
): TailscaleWebSocketProbe {
...
export const probeTailscaleWebSocketUpgrade = createTailscaleWebSocketProbe();
